#!/bin/sh
# Original code by iGold from:
# http://www.hydrogenaudio.org/forums/lofiversion/index.php/t42005.html

# NOTE: This must run on an album directory so that the album gain 
# calculation works.
